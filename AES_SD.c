...
void main()
{
    ...
    CLKPR=0x80;
    CLKPR=1;    //Micro TrabajarÃ¡ a 8MHz
...
//                EraseLCD();
               ...
               {      
                    ...
                    i=archivo1.fsize%16;        //Calcula el nÃºmero de bytes del Ãºltimo bloque 
...
//                EraseLCD();
//                MoveCursor(0,0);
//                StringLCD("Archivo a desencriptar");
//                MoveCursor(0,1);
//                StringLCDVar(Cadena);              
//                delay_ms(2500);
//                EraseLCD();
               ...
               {                                           
                 printf("Error al generar archivo de salida %i",res);
                 ImprimeError(res);                
                 error=1;
               }
            }      
